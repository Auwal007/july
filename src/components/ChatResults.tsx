    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50">
      <div className="max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-6">
          ...
          {/* AI Assessment Quality Indicator */}
          {assessmentData.assessmentType && (
            <div className="mt-4 pt-4 border-t border-gray-200">
              <div className="flex items-center space-x-3">
                <Brain className="w-5 h-5 text-blue-600" />
                <div className="flex-1">
                  {assessmentData.assessmentType === 'ai_generated' && (
                    <div className="flex items-center space-x-2">
                      <span className="text-sm font-medium text-green-700">✅ AI-Powered Personalized Assessment</span>
                      <span className="px-2 py-1 bg-green-100 text-green-800 text-xs rounded-full">Premium Quality</span>
                    </div>
                  )}
                  {assessmentData.assessmentType === 'ai_simplified' && (
                    <div className="flex items-center space-x-2">
                      <span className="text-sm font-medium text-blue-700">🤖 AI-Enhanced Assessment</span>
                      <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded-full">High Quality</span>
                    </div>
                  )}
                  {assessmentData.assessmentType === 'conversation_aware_fallback' && (
                    <div className="flex items-center space-x-2">
                      <span className="text-sm font-medium text-orange-700">📝 Conversation-Based Assessment</span>
                      <span className="px-2 py-1 bg-orange-100 text-orange-800 text-xs rounded-full">Standard Quality</span>
                    </div>
                  )}
                  <p className="text-xs text-gray-600 mt-1">
                    This assessment was generated based on your actual conversation and responses during the AI interview.
                  </p>
                </div>
              </div>
            </div>
